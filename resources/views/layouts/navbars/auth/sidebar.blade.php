<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
      <img src="{{ asset('assets/img/onedry-logo.png') }}" class="navbar-brand-img" alt="Logo" style="height:80px; margin-left:10px;">
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('pelanggan') ? 'active' : '') }} " href="{{ route('pelanggan') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('layanan') ? 'active' : '') }}" href="{{ url('layanan') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg">
              <path fill="{{ Request::is('layanan') ? '#FFFFFF' : '#344767' }}"
                d="M528.12 301.319l47.273-208C577.8 82.634 565.948 64 548.579 64H112L102.4 19.2C99.823 6.23 88.831 0 80 0H16C7.163 0 0 7.163 0 16s7.163 16 16 16h50.745l70.545 310.4C156.158 371.525 195.902 400 240 400h256c8.837 0 16-7.163 16-16v-48c0-8.837-7.163-16-16-16H240c-13.255 0-24-10.745-24-24v-8h286.939c14.499 0 27.117-10.227 29.181-24.681zM160 480c26.51 0 48-21.49 48-48s-21.49-48-48-48-48 21.49-48 48 21.49 48 48 48zm288 0c26.51 0 48-21.49 48-48s-21.49-48-48-48-48 21.49-48 48 21.49 48 48 48z" />
            </svg>
          </div>
        ...
        <a class="nav-link {{ (Request::is('laporan') ? 'active' : '') }}" href="{{ url('laporan') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 384 512" xmlns="http://www.w3.org/2000/svg">
              <path fill="{{ Request::is('laporan') ? '#FFFFFF' : '#344767' }}"
                d="M224 136c0-13.3-10.7-24-24-24s-24 10.7-24 24V328c0 13.3 10.7 24 24 24s24-10.7 24-24V136zM192 416c-17.7 
            0-32 14.3-32 32s14.3 32 32 32s32-14.3 32-32s-14.3-32-32-32zM80 0C35.8 0 0 35.8 0 80V432c0 44.2 
            35.8 80 80 80H304c44.2 0 80-35.8 80-80V80c0-44.2-35.8-80-80-80H80z" />
            </svg>
          </div>
