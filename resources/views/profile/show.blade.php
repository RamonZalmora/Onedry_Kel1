    ...
    <div class="bg-white rounded-2xl shadow-lg border border-purple-100 p-8 flex flex-col md:flex-row gap-10">
        ...
        <div class="flex flex-col items-center md:w-1/3 text-center border-r md:border-gray-200">
            <div class="relative">
                ...
                <label for="foto" class="absolute bottom-2 right-2 bg-purple-600 hover:bg-purple-700 text-white text-xs px-3 py-1 rounded-full cursor-pointer shadow-md">
                    Ubah
                </label>
        ...
        <div class="flex-1">
            ...
            <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="space-y-5">
                ...
                <div class="flex justify-between items-center pt-4 border-t">
                    <a href="{{ route('dashboard') }}" class="text-purple-600 hover:underline text-sm">
